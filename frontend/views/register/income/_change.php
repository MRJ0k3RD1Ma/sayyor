...
?>
<?php $form = ActiveForm::begin(['action'=>Yii::$app->urlManager->createUrl(['/register/incomesamples','id'=>$model->id,'route_id'=>$route->id,'regid'=>$reg->id])]); ?>

<?= $model->kod ?> <?= Yii::t('register', 'Raqamli namunaga berilgan topshiriq ma`lumotlarini o`zgartirish') ?>
<?php
$lg = 'uz';
...
<?php }?>
    ...
    <div class="table-responsive">
        ...
        <table class="table table-hover table-bordered">
            ...
            <tbody>
            <?php  foreach (\common\models\ResultAnimalTests::find()->where(['route_id'=>$route->id])->all() as $item): ?>
                <tr>
