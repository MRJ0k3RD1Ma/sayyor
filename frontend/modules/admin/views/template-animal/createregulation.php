...
?>
    ...
    <div class="tamplate-animal-form">
        <div class="row">
            ...
            <?= $form->field($model,'regulation_id')->dropDownList(ArrayHelper::map($regs,'id','name_uz'),['prompt'=>'Hujjatni tanlang','class'=>'form-control select2list'])->label('Hujjatni tanlang')?>
