                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($item->status_id == 0){?>
                                <a href="<?= Yii::$app->urlManager->createUrl(['/legal/deleteanimal','id'=>$item->id])?>" data-confirm="Siz rostdan ham ushbu namunani o`chirmoqchimisiz?" class="btn btn-danger"><span class="fa fa-trash"></span></a>
                            <?php }?>
                        </td>
                    </tr>
                    <?php
