...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 28, 2021 at 10:10 AM
...
--
DELIMITER $$
CREATE TRIGGER `save_pass_to_history` AFTER UPDATE ON `employees` FOR EACH ROW BEGIN
  IF OLD.PASSWORD <> NEW.password THEN
  BEGIN
    INSERT INTO employee_passwords_history (emp_id, Pass, change_time)
...
(1, '$2y$13$YvZdjBhlfFNZiV2hGpNrpe2lqe6vgOGNWs/BfD6qwdpzNZUf4Metm', '2021-11-13 11:00:51'),
(1, '$2y$13$OvvvZjcNDjjYlLMX9x7cs..JQuiq3MjslczRozrNOsTUdEZI33TEe', '2021-11-13 11:01:23'),
(1, '$2y$13$ZKa/Z1lCi5QLt/oo2kRBNeE5jKtYKv5AgJsnfkZ.qAPClLUZRAF3y', '2021-11-13 11:02:37');
...
) ENGINE=InnoDB AVG_ROW_LENGTH=160 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `organizations` (
  ...
  `GD_TEL_HOME` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(2, 651597, 201155766, 19, 26, 1, 'RESPUBLIKA MANAVIYAT TARGIBOT MARKAZI', 'ЯККАСАРОЙ УЛ.БОБУРА Д.9', '2012-04-20 14:00:00', '0000-00-00 00:00:00', '', '0', 2390518, '', '', 'KADIROV ALISHER KELDIYEVICH', 488586789, 2155045, '2332388', 'test@sayyor.uz', 'sayyor', '0', '', '', 94120, 15320785, 98400, 1726273, '', '0000-00-00 00:00:00', '2018-11-15 10:50:01', '2019-01-11 06:18:42', '1', b'1');
...
) ENGINE=InnoDB AVG_ROW_LENGTH=204 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
