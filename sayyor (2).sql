...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 29, 2021 at 09:19 AM
...
INSERT INTO `animal_category` (`id`, `name`) VALUES
(1, 'Sut emizuvchi');
...
INSERT INTO `animal_color` (`id`, `name`, `code`) VALUES
(1, 'Qora', '#000');

-- --------------------------------------------------------

--
-- Table structure for table `animal_gender`
--
...
--
-- Dumping data for table `animal_gender`
--
...
(73, 'ru', 'Виды животных'),
(74, 'ru', 'Пол животного'),
(75, 'ru', 'Цвет животного'),
(76, 'ru', 'Животные'),
(77, 'ru', 'Hayvon toifasini tanlang'),
(78, 'uz', 'Ma\'lumotnoma'),
(79, 'uz', 'Ichki'),
(80, 'uz', 'Tashqi');
...
(73, 'cp', 'Виды животных'),
(74, 'cp', 'Пол животного'),
(75, 'cp', 'Цвет животного'),
(76, 'cp', 'Животные'),
(77, 'cp', 'Hayvon toifasini tanlang'),
(78, 'cp.menu', 'Ma\'lumotnoma'),
(79, 'cp.menu', 'Ichki'),
(80, 'cp.menu', 'Tashqi');
...
--
-- Indexes for table `animal_color`
--
ALTER TABLE `animal_color`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `animal_gender`
--
...
--
-- AUTO_INCREMENT for table `animal_color`
--
ALTER TABLE `animal_color`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `animal_gender`
--
ALTER TABLE `animal_gender`
...
--
ALTER TABLE `animals`
  ADD CONSTRAINT `animals_ibfk_1` FOREIGN KEY (`cat_id`) REFERENCES `animal_category` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
